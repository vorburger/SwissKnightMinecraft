...
public class CommandRegistery {
	...
	public void registerCommand(PluginContainer plugin, String name, String commandDescription, CommandExecutorWithoutResultThrowsThrowable commandExecutorWithoutResultThrowsThrowable, CommandElement... args) {
		registerCommand(plugin, Collections.singletonList(name), commandDescription, commandExecutorWithoutResultThrowsThrowable, args);
	}
